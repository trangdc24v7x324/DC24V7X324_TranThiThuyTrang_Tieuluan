...
class ManagerWebChatPage extends StatefulWidget {
  ...
  @override
  State<ManagerWebChatPage> createState() =>
      _ManagerWebChatPageState();
}

class _ManagerWebChatPageState
    extends State<ManagerWebChatPage> {
  ...
  Future<void> _loadRooms({
    ...
    try {
      await _chatProvider.loadManagerChatSummary(
      ...
      if (mounted) {
        setState(() {
          _localError =
              'Không thể tải danh sách tin nhắn: $error';
        });
      }
    } finally {
      if (mounted) {
  ...
  void _syncSelectedRoom() {
    ...
    final matches = _chatProvider.rooms
        .where(
          (room) =>
              room.userId ==
              _selectedRoom!.userId,
  ...
  List<ChatRoomSummary> _filteredRooms(
  ...
  Widget build(BuildContext context) {
    ...
    final rooms =
        _filteredRooms(chatProvider.rooms);
...
class _MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final time =
        _formatMessageTime(message.created);
...
class _Avatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CircleAvatar(
      ...
      backgroundImage: url.trim().isEmpty
          ? null
          : NetworkImage(url),
