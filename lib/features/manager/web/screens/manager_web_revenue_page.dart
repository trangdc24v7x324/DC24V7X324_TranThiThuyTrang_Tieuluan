...
class ManagerWebRevenuePage extends StatefulWidget {
  ...
  @override
  State<ManagerWebRevenuePage> createState() =>
      _ManagerWebRevenuePageState();
}

class _ManagerWebRevenuePageState
    extends State<ManagerWebRevenuePage> {
  String _range = '30d';
  ...
  List<OrderModel> _completedInRange(
  ...
  Widget build(BuildContext context) {
    ...
    final completed =
        _completedInRange(orderProvider.orders);
    ...
    final chartPoints =
        _buildChartPoints(completed, _range);

    final topProducts =
        _buildProductStats(completed);

    final categories =
        _buildCategoryStats(completed);
                ...
                child: ConstrainedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      else if (orderProvider.errorMessage !=
                              null &&
                          orderProvider.orders.isEmpty)
                        _ErrorCard(
          ...
          final selector = SizedBox(
            ...
            child:
              ...
              items: const [
                ...
                DropdownMenuItem(
                  value: '90d',
                  child: Text('90 ngày gần nhất'),
                ),
                DropdownMenuItem(
                  value: 'all',
                  child: Text('Toàn bộ dữ liệu'),
                ),
              ],
...
class _RevenueKpiCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      constraints:
          const BoxConstraints(minHeight: 126),
      padding: const EdgeInsets.all(17),
      decoration: BoxDecoration(
        color: AppColors.surface,
        borderRadius: BorderRadius.circular(19),
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  ...
                  children: points.map((point) {
                    ...
                    final barHeight =
                        math.max(8.0, ratio * 205).toDouble();
...
class _TopProductsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _AnalyticsCard(
      ...
      subtitle:
          'Xếp hạng theo số lượng trong đơn hoàn thành',
...
class _CategoryBreakdownCard
  ...
  Widget build(BuildContext context) {
    ...
    return _AnalyticsCard(
      ...
      subtitle:
          'Tỷ trọng doanh thu của từng nhóm món',
...
class _RecentCompletedOrders
    extends StatelessWidget {
  final List<OrderModel> orders;

  const _RecentCompletedOrders({
  ...
  Widget build(BuildContext context) {
    return _AnalyticsCard(
      ...
      subtitle:
          'Các giao dịch mới nhất trong khoảng đã chọn',
